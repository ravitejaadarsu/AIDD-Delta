...
description: AIDD Master Supervisor duties — audit log, phase-boundary compliance audits, violation remediation. Use at every phase boundary and when reviewing supervision reports.
---
...
boundary dispatch `aidd-master-supervisor`; mirror its verdict into state; VIOLATIONS
